...
class cleanup_task extends \core\task\scheduled_task {
    ...
    public function get_name(): string {
        return get_string('taskcleanup', 'booktool_importpptx');
    }
    ...
    public function execute(): void {
        ...
        $records = $DB->get_records_select(
            ...
            [
                'component' => \booktool_importpptx\pending_file::COMPONENT,
                'filearea' => \booktool_importpptx\pending_file::FILEAREA,
                'cutoff' => $cutoff,
            ]
        );
        $count = 0;
        ...
        if ($count > 0) {
            mtrace("booktool_importpptx: removed {$count} abandoned staged upload file(s).");
        }
    }
}
