...
class renderer {
    ...
    public static function is_available(): bool {
        ...
        $cached = get_config('booktool_importpptx', 'officeavailable');
        $checked = (int) get_config('booktool_importpptx', 'officeavailablecheck');
        ...
        set_config('officeavailable', self::$available ? 1 : 0, 'booktool_importpptx');
        set_config('officeavailablecheck', time(), 'booktool_importpptx');
        return self::$available;
    }
