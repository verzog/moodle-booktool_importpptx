...
class office_importer {
    ...
    /**
     * Extracts a slide's chapter title for the image backend.
     *
     ...
     * 7") still names the chapter instead of falling back to "Slide N".
     *
     * @param \DOMDocument $doc The parsed slide document.
     ...
     * (longer than a badge, within the title length), it becomes the chapter
     * title; anything else (a leading picture, a multi-line body, a long text
     * block) yields no title, so the caller keeps the numbered fallback.
     * Footer/slide-number/date furniture and short badge labels are ignored,
     * exactly as the editable parser drops them before ordering.
     *
